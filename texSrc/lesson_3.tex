...
\begin{frame}
  ...
  \begin{block}{Optional}
    \begin{itemize{
    \item Programs compiled with \alert{\texttt{gcc}} inside Cygwin can be executed only inside Cygwin.
    ...
    \item A nice code editor for windows is \alert{notepad++}, you can find it here: \url{https://notepad-plus-plus.org/download/}.
    \item An alternative to CygWin, easier to install can be \alert{Mingw}, you can find it here: \url{http://www.mingw.org/}. The only needed package is \alert{\texttt{mingw32-base}}.
  \end{block}
\end{frame}
\end{document}
